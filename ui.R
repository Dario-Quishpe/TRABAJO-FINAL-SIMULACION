...
navbarPage("Modulos",theme=shinytheme("journal"),
           navbarMenu("Teorema del Límite Central (Distribuciones Discretas)",
                      tabPanel("Distribución Binomial",tags$style("h4 {color: black font-family: roman}"),
           ...
           tabPanel("Kolmogorov - Smirnov",
                    h4("Test de Kolmogorov - Smirnov",style = "background:#FEE9DF  ;text-align:center;align-items:center;color:'black';padding:25px;font-size:1.5em",align="center"),
                    fluidRow(
                      column(4, 
